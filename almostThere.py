...
fulldata={ "Qal": "Erik","building": ['rr','ob','pw'],'dcnum': 120930232, "pc": {"specs": [1,2,3,4,5], "power": "true", "storageGB": 128}, "people": [{"Erik": [3,2,5,2]}, {"Erik2": {333,1,9} }] }
relevant=pull_data(fulldata,['specs','building', "Erik"])
...
#Next steps: fix decode_all, learn about json for python (files into objects), determine proper methods to convert manifest file into object
